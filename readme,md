# Transformación Digital - Team 14
...
1. **Amazon QuickSight**: Una herramienta de análisis de datos y visualización de AWS que permite crear dashboards interactivos y reportes paginados. QuickSight se integra fácilmente con Odoo (ERP utilizado por Fuego Azteca) y con Amazon Marketplace Web Service (MWS), lo que facilita la obtención y el procesamiento de datos de ventas en Amazon. Además, QuickSight es una solución cloud, low-code y escalable.
